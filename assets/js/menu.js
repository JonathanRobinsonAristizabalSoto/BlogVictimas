...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function resetMenu() {
        ...
        titulo.style.transform = 'translateY(-1500px)'; // Resetea la posición del título

        enlacesMenu.style.opacity = 0; // Hace invisibles los enlaces del menú
        enlacesMenu.style.transform = 'translateY(-1000px)'; // Resetea la posición de los enlaces del menú
